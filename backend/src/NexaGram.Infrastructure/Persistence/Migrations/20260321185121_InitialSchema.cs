        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Media = table.Column<string>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ViewCount = table.Column<int>(type: "integer", nullable: false),
                    Layers = table.Column<string>(type: "jsonb", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "text", nullable: false),
                    CanvasState = table.Column<string>(type: "jsonb", nullable: true),
                    ParticipantIds = table.Column<string>(type: "jsonb", nullable: false),
                    ResultPostId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollabSessions_Posts_ResultPostId",
                        column: x => x.ResultPostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_CollabSessions_users_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "character varying(2200)", maxLength: 2200, nullable: false),
                    LikeCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DirectMessages_Posts_SharedPostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollabSessions_CreatorId",
                table: "CollabSessions",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_CollabSessions_ResultPostId",
                table: "CollabSessions",
                column: "ResultPostId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DirectMessages_ExpiresAt",
                table: "DirectMessages",
                column: "ExpiresAt");
